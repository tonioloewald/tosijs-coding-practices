...
| service-compris | the services layer (née tosijs-services / tosijs-platform / loewald-dot-com — see the names note above; the repo is the `loewald-dot-com` row): RBAC, write pipeline, role resolution — the universal endpoint's decision layer | npm `latest` **0.1.0** (name-staked 2026-09-16; hand-maintained row) | **working through blockers** (install system, agent auth, logical collections, blobs, snapshot — tosijs-platform#5–9) | [npm](https://www.npmjs.com/package/service-compris) | 2026-09-17 |

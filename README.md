...
| [tosijs-timezone-picker](https://github.com/tonioloewald/tosijs-timezone-picker) | graphical timezone-picker web-component | 0.6.0 | 0.6.0 (npm publish finally landed, months after the tag — caught by a scoreboard audit; confirm-the-publish, releasing.md): linked to these practices; shipped as a blueprint + eagerly-hydrated component; bespoke demo → tosijs-ui doc site; fixed NaN quarter-hour offsets and value/timezone desync | [site](https://timezones.tosijs.net) · [changelog](https://github.com/tonioloewald/tosijs-timezone-picker/blob/main/CHANGELOG.md) | 2026-08-19 |

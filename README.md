...
| manta-recon | revival of *Manta* (2010 Unity iPhone game) on tosijs-3d — the "tech demo → shipped game" proving ground; local `~/manta-recon`, pre-git | — | recon phase: plan (MANTA-PLAN.md) + dig of the original UnityScript; flight/skimming constants extracted to flight-constants.md; next: sub flying on empty water via `b3d-aircraft` + an underwater regime | — | 2026-08-10 |

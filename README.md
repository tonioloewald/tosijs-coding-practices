...
| [tosijs-ui](https://github.com/tonioloewald/tosijs-ui) | web components + the doc-site system | 1.14.1 (repo · tag · npm all agree) | **1.13.0** published; 1.14.0 in flight (CodeMirror re-export surface #131, test-fence promotion RFC #142), upstream blocker tosijs#38 now cleared • recent line: silent-failure sweep (1.10.0) · WCAG AA palette + tunnel sharing (1.9.x) · build-failing audit gate (1.8.0) | [site](https://ui.tosijs.net) · [changelog](https://github.com/tonioloewald/tosijs-ui/blob/main/CHANGELOG.md) | 2026-09-10 |
...
| [tjs-lang](https://github.com/tonioloewald/tjs-lang) | TS dialect: runtime validation, safety boundaries, sandboxed VM | 0.13.12 (repo · tag · npm all agree) | ⚠️ **0.13.12 tagged, NOT published** — five defects of one class: passes misreading code that merely *mentions* their target syntax (#51) • 0.13.6: `defineAtom` defaults `effects:'io'` — capability-membrane security fix, shipped as a patch deliberately • 0.12.0: VM security review (SSRF, ReDoS) | [playground](https://tjs-platform.web.app) · [changelog](https://github.com/tonioloewald/tjs-lang/blob/main/CHANGELOG.md) | 2026-09-10 |
...
| [loewald-dot-com](https://github.com/tonioloewald/tosijs-platform) | Firebase full-stack platform (repo: `tosijs-platform`) | `package.json` **1.0.6** · **untagged** | quiet since 2026-07-11 | — | 2026-09-10 |

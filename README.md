...
| --- | --- | --- | --- | --- | --- |
| [tosijs](https://github.com/tonioloewald/tosijs) | path-based observant state | 1.7.6 | 1.7.6: light-DOM `parts` scoping (#20), computed-property registration crash, and `xinValue`/`xinPath` on `XinProps` (#19) all fixed; `Tosi*` blueprint types (Xin* deprecated); README/ecosystem/history/Angular docs overhaul. (1.7.1–1.7.5: packaging, line-height px regression, `-xin-event` retired→WeakMap dispatch, `-xin-data`→`-tosi-data` via getElementsByClassName, `on<Event>` warning.) Build host: tosijs-ui 1.7.2 | [site](https://tosijs.net) · [changelog](https://github.com/tonioloewald/tosijs/blob/main/CHANGELOG.md) | 2026-07-27 |

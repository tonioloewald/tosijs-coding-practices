...
| tosijs-virta | task surface — where tasks live and die (`<tosi-virta>`, CLI, MCP); private repo `github.com/tonioloewald/tosijs-virta`, deploys are the distribution | 0.5.2 (tag local; private) | **on the task board** — live status there; public history in the changelog | app: virta.tosijs.net · design: `DESIGN.md` in-repo | 2026-09-24 |

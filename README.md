...
| [tosijs-ui](https://github.com/tonioloewald/tosijs-ui) | web components + the doc-site system | 1.15.3 (repo · tag · npm all agree) | **1.15.3** — first release via OIDC + staged publishing (#178; provenance, 2FA approval, self-verifying run); `<tosi-dialog>` Escape fixed + `dialogWillClose` veto (#183); `<tosi-md sanitize>` opt-in, default in 1.16 (#179); doc-site sourcemaps stopped leaking build paths • **1.15.2** — tjs-lang peer admits 0.14.x (#182) • **1.15.1** — doc-test failures named the wrong line (#142) | [site](https://ui.tosijs.net) · [changelog](https://github.com/tonioloewald/tosijs-ui/blob/main/CHANGELOG.md) | 2026-09-26 |

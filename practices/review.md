...
claim in a remediation commit message or CHANGELOG that names a test or a behaviour must
point at a test that is red on the base and green on HEAD** — and a discriminating one at
